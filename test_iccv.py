...
def parse_args():
    ...
    parser.add_argument('--save', dest='resume', default='net_model/_91219_food/weights_8_3049_0.9788_0.9991.pth', type=str)
    parser.add_argument('--size',
                        dest='resize_resolution',
                        default=438,
                        type=int)
    parser.add_argument('--five_crop', dest='five_crop', action='store_true')
    parser.add_argument('--merge', dest='merge_result', action='store_true')
...
def get_clean_label_by_mul_model(file_list, source_dir='', image_save=''):
    rows = []
    probs = collections.OrderedDict()
...
if __name__ == '__main__':
    args = parse_args()
    merge_result = args.merge_result
    ...
    data_set = dataset(Config,
                       ...
                       if five_crop else transformers['val_totensor'],
                       test=True)
